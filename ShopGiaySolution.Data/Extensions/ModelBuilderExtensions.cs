...
namespace ShopGiaySolution.Data.Extensions
{
    public static class ModelBuilderExtensions
    {
        ...
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            new AppConfig() { Key = "HomeTitle", Value = " This is home page of ShopGiaySolution " },
            new AppConfig() { Key = "HomeKeyword", Value = " This is keyword of ShopGiaySolution " },
            new AppConfig() { Key = "HomeDescription", Value = " This is description of ShopGiaySolution " }
            );
            ...
            modelBuilder.Entity<AppUser>().HasData(new AppUser
            {
                ...
                Email = "tranvanhuu76@gmail.com",
                NormalizedEmail = "tranvanhuu76@gmail.com",
                EmailConfirmed = true,
                PasswordHash = hasher.HashPassword(null!, "Abcd1234$"),
                SecurityStamp = string.Empty,
                FirstName = "Huu",
                LastName = "Van",
                Dob = new DateTime(2022, 01, 31)
            });
